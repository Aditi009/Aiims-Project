...
<div class="hero-section hero-slider owl-carousel owl-theme">
    <div class="hero-single" style="background-image: url({{ asset('web/images/delhi4.jpeg') }})">
        <div class="container">
...
<div class="hero-single" style="background-image: url({{ asset('web/images/delhi2.jpeg') }})">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-7 col-lg-7">
                <div class="hero-content" style="height: 400px">
            ...
            <div class="about-left">
                ...
                <div class="about-left-content">
                    ...
                    <div class="about-left-info">
                        <ul>
                            <li style="
                                    font-weight: 900;"><i class="lni-check-mark-circle"></i><span class="text">Dr.
                                    Lokesh Kashyap
                                </span></li>
            ...
            <div class="col-lg-6 mx-auto">
                ...
                <div class="row justify-content-center">
                    <div class="card" style="width: 700px;">
                        ...
                        <div class="card-body">
                            <h3 style="color:black" class="card-text">Scan the QR Code for Registration after account transfer.</h3>
