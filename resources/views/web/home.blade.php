    ...
    <div class="row justify-content-center">
        <div class="col-md-3 img-container-hod">
            ...
            <div class="row justify-content-center text-center">
                <ul>
                    <li style="font-weight: 900;font-size: 24px; color:maroon;"><i class="lni-check-mark-circle"></i><span
                            class="text">Dr.
                            Lokesh Kashyap
                        </span></li>
        ...
        <div class="col-md-8 ml-2 mr-2">
            ...
            <br/>
                ...
                the most recent approaches! Point of Care ultrasound for the anaesthesiologist is an essential skill for all anaesthesiologists! The faculty involved in POCUS are experts who will make it possible for you to assimilate POCUS in your day to day practice!  Need I say more…… 
...
{{-- 
<div class="testimonial-area bg py-20">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 mx-auto">
                <div class="site-heading text-center">
