    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="service-item">
                    <div class="service-img">
                        <img src="{{asset('web/images/service-04.jpg')}}" alt="">
                    </div>
                    <div class="service-content">
                        <div class="service-content-info">
                            <div class="service-icon">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="service-item">
                    ...
                    <div class="service-content">
                        <div class="service-content-info">
                            <div class="service-icon">
                                <i class="flaticon-couple-1"></i>
                            </div>
                            <h3 class="service-title">
                                <a href="#">Couple Counseling</a>
                            </h3>
                        </div>
                        <p class="service-text">
                            There are many variations of passages available but the majority have suffered
            ...
            <div class="col-md-6 col-lg-4">
                <div class="pricing-item">
                    ...
                    <div class="pricing-icon">
                        <i class="flaticon-shiny-tooth"></i>
                    </div>
                    ...
                    <div class="pricing-feature">
                        <ul>
                            <li><i class="far fa-check"></i> All Basic Service</li>
                            <li><i class="far fa-check"></i> Free Equipment Use</li>
                            <li><i class="far fa-check"></i> 5 Days Appointment</li>
                            <li><i class="far fa-check"></i> Advanced Options</li>
                            <li><i class="far fa-check"></i> 24/7 Support</li>
                        </ul>
                    </div>
                    <div class="pricing-footer">
                        <a href="#" class="theme-btn">Buy Now <i class="far fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-4">
...
<div class="video-area mt-20" style="background-image: url({{asset('web/assets/img/video/video.jpg')}});">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-12">
                    ...
                    <div class="appointment-form">
                        <form action="#">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <button type="submit" class="theme-btn">Get Appointment <i
            ...
            <div class="col-lg-6">
                <div class="choose-wrapper">
                    <div class="site-heading mb-3">
                        ...
                        <h2 class="site-title">Patients Are Happy, Cause Proper Mental Cure Support</h2>
                    </div>
                    <div class="choose-content">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incid
                            idunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exerc
                            itation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure
                                    ...
                                    <ul>
                                        <li>
                                            <div class="choose-content-text">
                                                <span>Highest Quality Service</span>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="choose-content-text">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="faq-left">
                    ...
                    <a href="#" class="theme-btn mt-5">Ask Your Question <i
                            class="far fa-arrow-right"></i></a>
                </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row">
            <div class="col-md-7 mx-auto">
                <div class="cta-wrapper text-center">
                    <h1>Are You Looking For Psychology Consultation?</h1>
...
<div class="partner-area pt-70 pb-70">
    <div class="container">
        <div class="partner-wrapper partner-slider owl-carousel owl-theme">
            <img src="{{asset('web/images/partner-01.jpg')}}" alt="thumb">
            <img src="{{asset('web/images/partner-02.jpg')}}" alt="thumb">
            <img src="{{asset('web/images/partner-03.jpg')}}" alt="thumb">
            <img src="{{asset('web/images/partner-04.jpg')}}" alt="thumb">
            <img src="{{asset('web/images/partner-01.jpg')}}" alt="thumb">
            <img src="{{asset('web/images/partner-02.jpg')}}" alt="thumb">
            <img src="{{asset('web/images/partner-03.jpg')}}" alt="thumb">
        </div>
